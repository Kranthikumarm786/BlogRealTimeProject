...
#send_mail('Hello', 'Very imp msg....','Kranthikumarm786@gmail.com',['shivachidurala123@gmail.com','yyy@gmail.com'])
...
def mail_send_view(request,id):
    ...
    if request.method=='POST':
        ...
        if form.is_valid():
            ...
            send_mail(subject, message, 'Kranthikumarm786@gmail.com', [cd['to']]) #use[] or ()tuple
            sent=True;
    else:
	    form=EmailSendForm()
